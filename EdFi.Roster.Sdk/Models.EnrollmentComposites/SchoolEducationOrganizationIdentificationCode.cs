...
namespace EdFi.Roster.Sdk.Models.EnrollmentComposites
{
    ...
    public partial class SchoolEducationOrganizationIdentificationCode :  IEquatable<SchoolEducationOrganizationIdentificationCode>, IValidatableObject
    {
        ...
        public SchoolEducationOrganizationIdentificationCode(string educationOrganizationIdentificationSystemDescriptor = default(string), string identificationCode = default(string))
        {
            ...
            {
                throw new InvalidDataException("educationOrganizationIdentificationSystemDescriptor is a required property for SchoolEducationOrganizationIdentificationCode and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("identificationCode is a required property for SchoolEducationOrganizationIdentificationCode and cannot be null");
            }
            else
            {
